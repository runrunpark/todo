          ...
          <div className="item-actions">
            {confirmDelete ? (
              <div className="confirm-delete">
                ...
                <button className="btn-confirm-yes" onClick={onDelete}>삭제</button>
                <button className="btn-confirm-no" onClick={() => setConfirmDelete(false)}>취소</button>
              </div>
            ) : (
              <>
                ...
                <button className="action-btn delete-btn" onClick={() => setConfirmDelete(true)} aria-label="삭제">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
